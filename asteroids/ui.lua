...
function M.load()
  fonts.tiny = love.graphics.newFont("fonts/Exo2-Regular.ttf", 12)
  fonts.small = love.graphics.newFont("fonts/Exo2-Regular.ttf", 18)
  fonts.medium = love.graphics.newFont("fonts/Exo2-Regular.ttf", 22)
  fonts.large = love.graphics.newFont("fonts/Exo2-Regular.ttf", 32)
  fonts.huge = love.graphics.newFont("fonts/Exo2-Regular.ttf", 48)
  fonts.hud = love.graphics.newFont("fonts/Exo2-Regular.ttf", 16)
  fonts.hudMed = love.graphics.newFont("fonts/Exo2-Regular.ttf", 16)
  fonts.hudLabel = love.graphics.newFont("fonts/Exo2-Regular.ttf", 14)
  fonts.hudSmall = love.graphics.newFont("fonts/Exo2-Regular.ttf", 12)
  fonts.mapSector = love.graphics.newFont("fonts/Exo2-Regular.ttf", 18)
  fonts.mapCoords = love.graphics.newFont("fonts/Exo2-Regular.ttf", 18)
  fonts.title = love.graphics.newFont("fonts/Exo2-Regular.ttf", 36)
  fonts.subtitle = love.graphics.newFont("fonts/Exo2-Regular.ttf", 28)
